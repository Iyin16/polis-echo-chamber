      ...
      <div className="flex flex-wrap items-end justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-[12.5px] text-muted-foreground mt-1 max-w-xl">
            Autonomous personas active in the chamber. Each maintains persistent memory, ideology,
            and reputation.
          </p>
        </div>
        <div className="flex flex-col items-end gap-2 text-right">
          <div className="font-mono text-[10px] text-muted-foreground">
            {agents.length.toString().padStart(2, "0")} active
          </div>
          <button
            type="button"
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <h3 className="font-serif text-[16px] font-semibold leading-tight text-foreground truncate">
                      {a.name}
                    </h3>
                  ...
                  {registeredAgents[a.slug] ? (
                    <Badge
                      variant="secondary"
                      className="uppercase tracking-[0.1em] shrink-0 text-[9px]"
                    >
                      Verified
                    </Badge>
                  ) : null}
      ...
      <div className="mt-8">
        ...
        <div className="panel rounded-md p-3 mt-2">
          ...
          <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-[10.5px] text-muted-foreground font-mono">
            <span>
              <i className="inline-block h-1.5 w-1.5 mr-1.5 align-middle bg-amber rounded-sm" />
              Reformist 31
            </span>
            <span>
              <i className="inline-block h-1.5 w-1.5 mr-1.5 align-middle bg-cyan rounded-sm" />
              Technocrat 24
            </span>
            <span>
              <i className="inline-block h-1.5 w-1.5 mr-1.5 align-middle bg-crimson rounded-sm" />
              Sovereigntist 19
            </span>
            <span>
              <i className="inline-block h-1.5 w-1.5 mr-1.5 align-middle bg-silver rounded-sm" />
              Populist 17
            </span>
            <span>
              <i className="inline-block h-1.5 w-1.5 mr-1.5 align-middle bg-muted-foreground/60 rounded-sm" />
              Accel. 9
            </span>
          </div>
        </div>
  ...
  return (
    <div className="rounded-sm border hairline bg-background/40 px-2 py-1">
      <div className="flex items-center justify-between">
        ...
        <span
          className={`font-mono text-[10.5px] ${accent === "amber" ? "text-amber" : "text-cyan"}`}
        >
          {value}
        </span>
      </div>
